    ...
    <div style={{ minHeight: "100vh", display: "flex" }}>
      ...
      <div style={{ flex: "0 0 480px", background: "linear-gradient(160deg, #02066F 0%, #0A0F3C 60%, rgba(255,165,0,0.05) 100%)", display: "flex", flexDirection: "column", padding: "40px 48px", borderRight: "1px solid rgba(255,255,255,0.08)", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ marginBottom: "auto", marginTop: 48 }}>
          <h2 style={{ fontSize: 28, fontWeight: 700, marginBottom: 16, lineHeight: 1.3 }}>Your goals deserve a real shot.</h2>
        ...
        {/* Testimonial */}
        <div style={{ display: "flex", alignItems: "center", gap: 12, background: "rgba(255,255,255,0.04)", borderRadius: 12, padding: "14px 16px", border: "1px solid rgba(255,255,255,0.08)" }}>
          <div style={{ width: 40, height: 40, borderRadius: "50%", background: "linear-gradient(135deg, #FFA500, #02066F)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, fontWeight: 700, flexShrink: 0 }}>C</div>
          <div>
            <p style={{ fontSize: 13, fontWeight: 600 }}>Chinonso K.</p>
            <p style={{ fontSize: 12, color: "rgba(255,255,255,0.5)" }}>"Hua helped me hit my first ₦1M month as a freelancer."</p>
          </div>
        </div>
      </div>
