...
export default function LandingPage() {
  return (
    <div className="hero-gradient" style={{ minHeight: "100vh" }}>
      ...
      {/* Navbar */}
      <nav className="landing-nav" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "20px 48px", borderBottom: "1px solid rgba(0,0,0,0.07)", backdropFilter: "blur(20px)", position: "sticky", top: 0, zIndex: 100, background: "rgba(252,252,250,0.85)" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 22, color: "#1a1a2e" }}>Hua</span>
        </div>
      ...
      <div className="landing-section" style={{ maxWidth: 1100, margin: "0 auto", padding: "64px 48px 50px", textAlign: "center" }}>
        <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "rgba(255,165,0,0.1)", border: "1px solid rgba(255,165,0,0.25)", borderRadius: 100, padding: "6px 16px", marginBottom: 28 }}>
          ...
          <span style={{ fontSize: 12, color: "#c2790a", fontWeight: 500 }}>Built for African Freelancers & Founders</span>
        </div>

        <h1 style={{ fontSize: "clamp(32px, 7vw, 68px)", fontWeight: 800, lineHeight: 1.15, marginBottom: 20, letterSpacing: "-1.5px", color: "#1a1a2e" }}>
          Set goals that<br />
        ...
        <p style={{ fontSize: "clamp(14px, 2.5vw, 18px)", color: "#4b5563", maxWidth: 560, margin: "0 auto 32px", lineHeight: 1.7, padding: "0 8px" }}>
      ...
      <div className="landing-section" style={{ maxWidth: 1100, margin: "0 auto", padding: "32px 48px 64px" }}>
        <h2 style={{ fontSize: "clamp(24px, 5vw, 36px)", fontWeight: 700, textAlign: "center", marginBottom: 8, letterSpacing: "-1px", color: "#1a1a2e" }}>Everything you need to thrive</h2>
        <p style={{ textAlign: "center", color: "#6b7280", marginBottom: 40, fontSize: 14 }}>Built with the African hustle in mind</p>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))", gap: 16 }}>
          {FEATURES.map((f) => (
            <div key={f.title} className="card" style={{ padding: 22 }}>
              ...
              <h3 style={{ fontSize: 15, fontWeight: 700, marginBottom: 7, color: "#1a1a2e" }}>{f.title}</h3>
      ...
      <div className="landing-section" style={{ maxWidth: 700, margin: "0 auto", padding: "0 48px 50px" }}>
        <div className="pricing-card card" style={{ padding: 36, textAlign: "center", background: "#fff8ed", border: "1px solid rgba(255,165,0,0.2)" }}>
          <h2 style={{ fontSize: "clamp(18px, 4vw, 22px)", fontWeight: 700, marginBottom: 8, color: "#1a1a2e" }}>Simple, one-time pricing</h2>
          <p style={{ color: "#6b7280", marginBottom: 22, fontSize: 13 }}>Pay once. Use Hua forever. No subscriptions, no hidden fees.</p>
          <div style={{ display: "flex", justifyContent: "center", alignItems: "baseline", gap: 8, marginBottom: 22, flexWrap: "wrap" }}>
            <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 800, fontSize: "clamp(36px, 8vw, 48px)", color: "#c2790a" }}>₦5,000</span>
            ...
            {["Unlimited goals & steps", "Progress tracking & streaks", "Email reminders", "Freelancer business guides", "All future updates included"].map(item => (
              <div key={item} style={{ display: "flex", alignItems: "flex-start", gap: 10, textAlign: "left" }}>
                <div style={{ width: 18, height: 18, borderRadius: "50%", background: "rgba(255,165,0,0.15)", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: 1 }}>
                  <svg width={10} height={10} viewBox="0 0 24 24" fill="none" stroke="#c2790a" strokeWidth="3"><path d="M20 6L9 17l-5-5" /></svg>
                </div>
          ...
          <p style={{ fontSize: 11, color: "#9ca3af", marginTop: 12 }}>Students get ₦3,000 with coupon code at checkout</p>
        </div>
      </div>

      {/* CTA */}
      <div className="landing-section" style={{ maxWidth: 600, margin: "0 auto", padding: "0 48px 64px", textAlign: "center" }}>
        <div className="card" style={{ padding: 36, background: "linear-gradient(135deg, #02066F, #0a1180)", border: "1px solid rgba(255,165,0,0.25)" }}>
          <div style={{ fontSize: 32, marginBottom: 14 }}>🔥</div>
          <h2 style={{ fontSize: "clamp(20px, 5vw, 28px)", fontWeight: 700, marginBottom: 10, color: "#fff" }}>Ready to start achieving?</h2>
          <p style={{ color: "rgba(255,255,255,0.65)", marginBottom: 24, fontSize: 13 }}>Join African freelancers building toward their goals every day.</p>
