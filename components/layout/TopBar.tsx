    ...
    <header style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
        <button
          ...
          style={{ background: "none", border: "none", color: "#6b7280", cursor: "pointer", display: "flex", padding: 6, borderRadius: 8 }}
        >
        ...
        <Link href="/dashboard" style={{ display: "flex", alignItems: "center", gap: 8, textDecoration: "none" }}>
          ...
          <h2 style={{ fontSize: 17, fontWeight: 700, fontFamily: "'Space Grotesk', sans-serif", color: "#1a1a2e" }}>{title}</h2>
        </Link>
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <Link href="/profile" style={{ display: "flex", alignItems: "center", gap: 10, textDecoration: "none" }}>
          <Avatar name={user?.full_name ?? "U"} size={34} src={user?.avatar_url ?? undefined} />
          <div style={{ textAlign: "left" }}>
            <p style={{ fontSize: 13, fontWeight: 600, fontFamily: "'Space Grotesk', sans-serif", color: "#1a1a2e", margin: 0 }}>
              {user?.full_name ?? "User"}
            </p>
