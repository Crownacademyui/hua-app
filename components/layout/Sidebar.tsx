  ...
  return (
    <aside
      style={{
        ...
        zIndex: 100,
        overflow: "hidden",
        background: "linear-gradient(180deg, rgba(2,6,111,0.6) 0%, rgba(10,15,60,0.95) 100%)",
    ...
    >
      ...
      <div style={{ padding: "20px 16px", borderBottom: "1px solid rgba(255,255,255,0.08)", display: "flex", alignItems: "center", gap: 12, minHeight: 72 }}>
        ...
        {!collapsed && (
          <span style={{ fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 20, letterSpacing: "-0.5px" }}>
            Hua
          </span>
        )}
      </div>
          ...
          return (
            ...
            >
              <svg width={18} height={18} viewBox="0 0 24 24" fill="none"
                stroke={isActive ? "#FFA500" : "currentColor"}
